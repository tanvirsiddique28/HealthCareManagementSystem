    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.addOrder(username,edFullname.getText().toString(),edAddress.getText().toString(),edContactnumber.getText().toString(),Integer.parseInt(edPincode.getText().toString()),date.toString(),time.toString(),Float.parseFloat(price[1]),"lab");
